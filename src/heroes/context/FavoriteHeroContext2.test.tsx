...
describe('FavoriteHeroContext', () => {
    ...
    it('should add hero to favorites when toggleFavorite is called with new Hero', () => {
        ...
        expect(localStorage.setItem).toHaveBeenCalledWith('favorites', '[{"id":"1","name":"batman"}]');
    });

    it('should remove hero to favorites when toggleFavorite is called with new Hero', () => {
