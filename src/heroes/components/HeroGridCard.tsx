    ...
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
        ...
        <CardHeader className="pb-3">
          <div className="flex justify-between items-start">
            ...
            <Badge className="text-xs bg-green-100 text-green-800 border-green-200">Héroe</Badge>
          </div>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-600 line-clamp-2">
            El último hijo de Krypton, protector de la tierra y simbolo de esperanza para toda la humanidad.
          </p>
          ...
          <div className="text-xs text-gray-500 pt-2 border-t">Primera aparición: 1938</div>
        </CardContent>
    </Card>
  )
}
